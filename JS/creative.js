 const verticalScrollWrap = document.querySelector('.vertical-scroll-wrapper');
        ...
        window.addEventListener('scroll', () => {
            ...
            // Phase 2: Text moves up, video appears (25% - 50%)
                ...
                mainVideoElement.style.opacity = phaseProgress;
            ...
            // Phase 3: Canvas appears, video shrinks to center, elements come inside (50% - 75%)
                ...
                // Video shrinks and stays centered in canvas
                const videoScaleFactor = 1 - (phaseProgress * 0.6);
            ...
            // Phase 4: Final state - marquee appears (75% - 100%)
                ...
                // Video at final size and centered
                mainVideoElement.style.opacity = 1;
                mainVideoElement.style.transform = `translate(-50%, -50%) scale(0.4)`;
                mainVideoElement.style.zIndex = 15;
